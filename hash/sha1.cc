...
void Sha1::Final() {
  ...
  memset(&bytes_waiting_[num_bytes_waiting_],0, (BLOCKBYTESIZE-num_bytes_waiting_-sizeof(uint64_t)));
#ifndef BIGENDIAN
  uint32_t*   psize= (uint32_t*)&bytes_waiting_[BLOCKBYTESIZE-sizeof(uint64_t)];
