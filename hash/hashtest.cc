...
uint32_t        sha1_test1_answer[5]= {0xA9993E36, 0x4706816A, 0xBA3E2571, 0x7850C26C, 0x9CD0D89D};

const byte* sha1_test2_toHash =
      (const byte*)"abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq";
uint32_t        sha1_test2_answer[5] = {0x84983E44, 0x1C3BD26E, 0xBAAE4AA1, 0xF95129E5, 0xE54670F1};
...
const byte sha3_output1[128] = {
    
};


const byte sha3_input128[]= { 
    
};

const byte sha3_output128[128] = {
    0xDC, 0xAC, 0x84, 0x56, 0x8F, 0x15, 0xCA, 0xC0,
    0x76, 0x85, 0x4E, 0xA6, 0x92, 0xDE, 0x95, 0xE4, 
    0x73, 0x76, 0x8A, 0x99, 0xDF, 0x9A, 0xC2, 0x32,
    0x8E, 0xE4, 0x23, 0xD0, 0x2E, 0xEB, 0x8E, 0xE8, 
    0xE1, 0xD1, 0x70, 0x62, 0x13, 0xC4, 0x41, 0x5D,
    0xC7, 0xAA, 0xFA, 0x66, 0x47, 0x6D, 0x8E, 0xBD, 
    0xDD, 0xD8, 0xBF, 0x39, 0xE1, 0xDE, 0x05, 0xCA,
    0x76, 0xC3, 0x6E, 0x7E, 0x97, 0x56, 0x29, 0x33, 
    0x1F, 0x3A, 0x33, 0xC3, 0xCA, 0x40, 0x91, 0xC8,
    0x20, 0x04, 0xE5, 0x89, 0x1B, 0x7E, 0x27, 0x6D, 
    0x46, 0x42, 0xEA, 0x61, 0xBD, 0xE0, 0x21, 0x87,
    0x1C, 0x9B, 0x5C, 0x8C, 0xFA, 0x82, 0x14, 0x4B, 
    0x7A, 0x41, 0x44, 0xB4, 0x4E, 0xBE, 0x60, 0x93,
    0xE9, 0x5C, 0x59, 0x30, 0x5F, 0xD3, 0x6A, 0x87, 
    0x41, 0xC4, 0xF2, 0xDF, 0x65, 0xCB, 0x0B, 0x59,
...
const byte sha3_output255[128] = {
    0x94, 0x35, 0xFC, 0x67, 0x1D, 0xFC, 0xFC, 0xDA,
    0xC1, 0x49, 0x27, 0x7E, 0x2C, 0xAA, 0xA8, 0x0E, 
    0xD3, 0xD4, 0xA2, 0x35, 0x93, 0x00, 0xDB, 0x89,
    0x2B, 0x80, 0x93, 0xDF, 0xFA, 0x94, 0x42, 0xBB, 
    0x5C, 0x08, 0xF2, 0x42, 0xF2, 0xFC, 0x2C, 0xB5,
    0xF8, 0x38, 0x80, 0x32, 0x29, 0x9F, 0x1D, 0xF4, 
    0x7A, 0x57, 0x48, 0x9A, 0x4F, 0xC0, 0xD6, 0x6D,
    0x88, 0xE4, 0x83, 0x09, 0x23, 0x20, 0xA4, 0x71, 
    0x89, 0x7F, 0xB6, 0xAD, 0xE6, 0x78, 0x97, 0xE5,
    0x13, 0x8C, 0x45, 0xF1, 0x91, 0x74, 0xA4, 0xB1, 
    0xAE, 0x0E, 0x51, 0x0F, 0xA3, 0x90, 0x82, 0x5D,
    0x17, 0x56, 0x89, 0x89, 0xC3, 0x65, 0x9F, 0xC5, 
    0x7B, 0x93, 0x45, 0xD7, 0xD9, 0x3E, 0xE5, 0x88,
    0xCB, 0x26, 0x29, 0xC5, 0x77, 0x08, 0x08, 0x19, 
    0x52, 0x57, 0xBB, 0xF4, 0x2B, 0x06, 0x95, 0x76,
...
bool SimpleSha3Test() {
  ...
  printf("\n");
  if(memcmp((byte*)sha3_output1, digest, 128)!=0)
    return false;
  ...
  printf("\n");
  if(memcmp((byte*)sha3_output128, digest, 128)!=0)
    return false;
  ...
  printf("\n");
  if(memcmp((byte*)sha3_output255, digest, 128)!=0)
    return false;
...
bool pkcsTest() {
  ...
  printf("encoded hash: "); PrintBytes(256, out); printf("\n");
  ...
  printf("embedded message: "); PrintBytes(256, out); printf("\n");
  if(!PkcsExtract(256, out, &new_out_size, new_out)) {
    printf("PkcsExtract failed\n");
    return false;
  }
  printf("retrieved message: "); PrintBytes(new_out_size, new_out); printf("\n");
...
bool pbkdfTest() {
  ...
  if(!pbkdf2("My voice is my password, hear me speak", salt_size, salt, 10,
            72, out)) {
    printf("pbkdf2 failed\n");
    return false;
  }
  printf("password derived key: "); PrintBytes(80, out); printf("\n");
  return true;
}
...
TEST(FirstPkcsCase, FirstPkcsTest) {
  EXPECT_TRUE(pkcsTest());
}
TEST(FirstKdfCase, FirstKdfTest) {
  EXPECT_TRUE(pbkdfTest());
}
