...
clean:
	...
	rm $(EXE_DIR)/test_prob.exe

test_prob.exe: $(dobj) 
	@echo "linking executable files"
	$(LINK) -o $(EXE_DIR)/test_prob.exe $(dobj) $(LDFLAGS)

$(O)/test_prob.o: $(S)/test_prob.cc
	@echo "compiling test_prob.cc"
	$(CC) $(CFLAGS) -c -o $(O)/test_prob.o $(S)/test_prob.cc
