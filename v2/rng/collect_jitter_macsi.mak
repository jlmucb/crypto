...
dobj=   $(O)/collect_jitter.o $(O)/support.pb.o $(O)/crypto_support.o $(O)/crypto_names.o \
	$(O)/hash.o $(O)/sha3.o $(O)/lz77.o $(O)/probability_support.o

all:    collect_jitter.exe
clean:
	@echo "removing object files"
	rm $(O)/*.o
	@echo "removing executable file"
	rm $(EXE_DIR)/collect_jitter.exe

collect_jitter.exe: $(dobj) 
	@echo "linking executable files"
	$(LINK) -o $(EXE_DIR)/collect_jitter.exe $(dobj) $(LDFLAGS)
...
$(O)/collect_jitter.o: $(S)/collect_jitter.cc
	@echo "compiling collect_jitter.cc"
	$(CC) $(CFLAGS) -c $(I) -o $(O)/collect_jitter.o $(S)/collect_jitter.cc
