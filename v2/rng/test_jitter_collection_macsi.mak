...
#    File: test_jitter_collection_macsi.mak
...
dobj=   $(O)/test_jitter_collection.o $(O)/support.pb.o $(O)/crypto_support.o $(O)/crypto_names.o \
	$(O)/hash.o $(O)/sha3.o $(O)/lz77.o $(O)/probability_support.o

all:    test_jitter_collection.exe
clean:
	@echo "removing object files"
	rm $(O)/*.o
	@echo "removing executable file"
	rm $(EXE_DIR)/test_jitter_collection.exe

test_jitter_collection.exe: $(dobj) 
	@echo "linking executable files"
	$(LINK) -o $(EXE_DIR)/test_jitter_collection.exe $(dobj) $(LDFLAGS)
...
$(O)/test_jitter_collection.o: $(S)/test_jitter_collection.cc
	@echo "compiling test_jitter_collection.cc"
	$(CC) $(CFLAGS) -c $(I) -o $(O)/test_jitter_collection.o $(S)/test_jitter_collection.cc
