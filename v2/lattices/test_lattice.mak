...
clean:
	...
	rm $(EXE_DIR)/test_lattice.exe

test_lattice.exe: $(dobj) 
	@echo "linking executable files"
	$(LINK) -o $(EXE_DIR)/test_lattice.exe $(dobj) $(LDFLAGS)
...
$(O)/test_lattice.o: $(S)/test_lattice.cc
	@echo "compiling test_lattice.cc"
	$(CC) $(CFLAGS) -c $(I) -o $(O)/test_lattice.o $(S)/test_lattice.cc
