...
echo ""
./cryptutil.exe --operation=EncryptWithScheme --key_file=aes128-gcm128-schemefile1 --algorithm=aes128-gcm128 --input_file=jlmTestSave1 --output_file=jlmTestSave5.enc
echo ""
